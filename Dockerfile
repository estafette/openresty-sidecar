...
ARG OPENTRACING_CPP_VERSION="1.6.0"
# https://github.com/opentracing-contrib/nginx-opentracing/releases/tag/v0.10.0
ARG OPENTRACING_NGINX_VERSION="0.10.0"
# https://github.com/jaegertracing/jaeger-client-cpp/releases/tag/v0.6.0
ARG JAEGER_CPP_VERSION="0.6.0"

# https://github.com/openresty/docker-openresty/blob/1.19.3.1-2/buster/Dockerfile
